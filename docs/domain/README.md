...
| [quant-analytics-user-value.md](./quant-analytics-user-value.md) | 포트폴리오 최적화·세금최적화·Kelly·패턴인식·국면감지가 사용자에게 실제로 주는 가치는 무엇인가? |

## 관련 문서

- [Product](../product.md) — 전체 기능 축, MVP 범위, 개발 단계
- [Technical Documentation](../technical/README.md) — 구현 상세
